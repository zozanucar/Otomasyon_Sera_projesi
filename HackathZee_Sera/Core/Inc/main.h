...
#define FLOW_RELAY_Pin GPIO_PIN_1
#define FLOW_RELAY_GPIO_Port GPIOB
#define FROST_RELAY_Pin GPIO_PIN_5
#define FROST_RELAY_GPIO_Port GPIOB
#define STEPPER_IN1_Pin GPIO_PIN_6
#define STEPPER_IN1_GPIO_Port GPIOB
#define STEPPER_IN2_Pin GPIO_PIN_7
